...
class Web extends CI_Controller {
											 ...
											 if ($cek_un->num_rows() != 0) {
												...
												//  $this->db->update('tbl_siswa', $data, array('nis' => $username));
												 ...
												 $level    = "siswa";
																...
																$this->session->set_userdata('prakrin_smk@Proyek-2022', "$cekun");
	...
	public function logout() {
     if ($this->session->has_userdata('prakrin_smk@Proyek-2022') and $this->session->has_userdata('id_user@Proyek-2022') and $this->session->has_userdata('level@Proyek-2022')) {
