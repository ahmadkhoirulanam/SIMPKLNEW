    ...
    <center>
		...
		<table>
			<tr class="text2">
				...
				<td width="625"> <font size="3"> :  /ST.PKL/INF/FTI/UPGRIS/2022  </font></td>
			</tr>
            <tr class="text2">
				<td><font size="3">Lamp</font></td>
				<td width="625"><font size="3"> : 1 (Surat Balasan Instansi PKL) </font></td>
			</tr>
			<tr class="text2">
				<td><font size="3">Hal</font></td>
				<td width="625"><font size="3"> : Permohonan Surat Tugas PKL</font></td>
			</tr>
		</table>
		<br>
		<table width="667">
		...
		<table width="667">
			<tr>
		       <td>
			       <font size="3">Dengan Hormat,<br>Berkenaan dengan telah diterimanya surat balasan dari Instansi/ Perusahaan tempat lokasi Praktek Kerja Lapangan (PKL), kami bermaksud mengajukan Surat Tugas PKL untuk mahasiswa sebagai berikut:</font>
		       </td>
		    </tr>
		</table>
		<br>
