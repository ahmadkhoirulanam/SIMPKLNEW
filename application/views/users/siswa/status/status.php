    ...
    <div class="row">
      <div class="col-md-12">
        <div class="alert alert-success alert-dismissible" role="alert">
          <i class="icon-checkmark-circle"></i> Selamat Datang di Sistem Informasi Praktik Kerja Lapangan
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="alert alert-danger alert-dismissible" role="alert">
          ...
          <a href="users/status_prakerin/p" class="btn btn-success" target="_blank"><i class="icon-cloud-download"></i> Surat Permohonan</a>
              ...
              <fieldset class="content-group"> 
                <legend class="text-bold"><i class="icon-cogs"></i> Status PKL</legend>
                  ...
                  <table width="100%" border=0>
                      ...
                      <tr>
                        <th><b>Nama Perusahaan/instansi</b></th>
                        <td><b>:</b>&nbsp; </td>
                ...
                <!-- <div class="form-group">
                  ...
                  <div class="col-lg-9">
                    <input type="text" name="nama_lengkap" class="form-control" value="<?php echo ucwords($kdpenempatan); ?>" placeholder="Nama Lengkap" maxlength="50" required>
                  </div>
                </div> -->

              </fieldset>
              <a href="users/surat" class="btn btn-danger" target="_blank"><i class="icon-cloud-download"></i> Cetak Surat Permohonan </a>
              <!-- <a href="users/surat" class="btn btn-danger" target="_blank"><i class="icon-cloud-download"></i> Cetak Surat Permohonan </a> -->
              <a href="users/surattugas" class="btn btn-primary" target="_blank"><i class="icon-cloud-download"></i> Cetak Surat Tugas </a>
              <!-- <a href="users/pdf" class="btn btn-warning" target="_blank"><i class="icon-cloud-download"></i> Cetak PDF </a>            -->
