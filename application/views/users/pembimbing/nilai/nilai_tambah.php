          ...
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="col-sm-12 pull-left" style="margin-top: 10px;">
              ...
              <select class="form-control" name="keterangan">
                ...
                <option value="Nilai-Dosen">Penilaian Dosen Pembimbing</option>
                <option value="Intansi">Penilaian Pembimbing Lapangan</option>
                <option value="Laporan">Laporan PKL Mahasiswa</option>
              </select>
            </div>
            <div class="col-sm-12 pull-left" style="margin-top: 10px;">
              <hr>
