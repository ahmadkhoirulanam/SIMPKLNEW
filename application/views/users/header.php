...
<body>
	...
	<div class="navbar navbar-default header-highlight">
		<div class="navbar-header">
			<a class="navbar-brand" href=""style="color:white;"> SIMPKL <span class="label bg-success-400">Informatika</span></a>
							...
							<div class="media">
								...
								<div class="media-body">
									...
									<div class="text-size-mini text-muted">
										...
										<!-- <i class="icon-pin text-size-small"></i> Mahasiswa -->
									</div>
								</div>
							</div>
						</div>
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<?php } ?>
									...
									<?php if ($level == 'Admin'){ ?>
										<li class="<?php if ($sub_menu == "dasboard") { echo 'active';}?>"><a href="users/dashboard"><i class="icon-home"></i> <span>Dashboard</span></a></li>
								...
								<?php }elseif ($level == 'Pembimbing'){?>
													<li class="<?php if ($sub_menu == "d_siswa") { echo 'active';}?>"><a href="users/d_siswa"><i class="icon-book3"></i> <span>Daftar Mahasiswa</span></a></li>
								...
								<?php }elseif ($level == 'Pembimbinglapangan'){?>
									<li class="<?php if ($sub_menu == "nilai") { echo 'active';}?>"><a href="users/nilai"><i class="icon-star-full2"></i> <span>Nilai Mahasiswa</span></a></li>				
									<li class="<?php if ($sub_menu == "d_siswa") { echo 'active';}?>"><a href="users/d_siswa"><i class="icon-book3"></i> <span>Daftar Mahasiswa</span></a></li>
