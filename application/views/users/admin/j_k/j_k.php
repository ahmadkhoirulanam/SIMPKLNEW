          ...
          <div class="tabbable">
            ...
            <div class="tab-content">
              <div class="tab-pane <?php if($sub_menu3 == ''){echo 'active';} ?>" id="tbl_kelas">
                ...
                ?>
                <a href="users/industri/t" class="btn btn-primary"><i class="icon-plus2"></i>Tambah Kelas</a>
                ...
                <table class="table datatable-basic table table-bordered table-striped" width="100%">
                  <thead>
                    <tr>
                      <th width="30px;">No.</th>
                      <th>Nama Kelas</th>
