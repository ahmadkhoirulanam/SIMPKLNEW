        ...
        <div class="panel-body">
          <div class="tabbable">
            <ul class="nav nav-tabs nav-tabs-highlight nav-justified">
              <li class="<?php if($sub_menu3 == ''){echo 'active';} ?>"><a href="#tbl_pemb" data-toggle="tab" aria-expanded="true">+ Dosen Pembimbing</a></li>
              <li class="<?php if($sub_menu3 == 'tbl_pemblap'){echo 'active';} ?>"><a href="#tbl_pemblap" data-toggle="tab" aria-expanded="true">+ Pembimbing Lapangan</a></li>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane <?php if($sub_menu3 == 'tbl_pemblap'){echo 'active';} ?>" id="tbl_pemblap">

                <?php
                echo $this->session->flashdata('msg_pemb');
                ?>
                <a href="users/pengguna/t_pemblap" class="btn btn-primary"><i class="icon-user-plus"></i> Pembimbing Lapangan Baru</a>
                ...
                <table class="table datatable-basic" width="100%">
                  ...
                  <tbody>
                      <?php
                      $no = 1;
                      foreach ($v_pemblap->result() as $baris) {
                      ?>
                        <tr>
                          <td><?php echo $no.'.'; ?></td>
                          <td><?php echo $baris->username; ?></td>
                          ...
                          <td><?php echo $baris->nip; ?></td>
                          <td>
                            <a href="users/pengguna/d_pemblap/<?php echo $baris->kdpemblap; ?>" class="btn btn-info btn-xs"><i class="icon-eye"></i></a>
                            <!-- <a href="users/pengguna/e_pemb/<?php echo $baris->kdpemblap; ?>" class="btn btn-success btn-xs"><i class="icon-pencil7"></i></a> -->
                            <a href="users/pengguna/h_pemblap/<?php echo $baris->kdpemblap; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Apakah Anda yakin?')"><i class="icon-trash"></i></a>
                          </td>
                        </tr>
                      <?php
                      $no++;
              ...
              <div class="tab-pane <?php if($sub_menu3 == 'tbl_siswa'){echo 'active';} ?>" id="tbl_siswa">
                ...
                ?>
                <a href="users/pengguna/t_siswa" class="btn btn-primary"><i class="icon-user-plus"></i> Tambah Mahasiswa</a>
