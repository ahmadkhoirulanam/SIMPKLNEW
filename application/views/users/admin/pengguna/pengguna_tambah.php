        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"><i class="icon-user-plus"></i> Tambah Pengguna <?php if ($sub_menu3 == 't_pemb') {echo "DOsen Pembimbing";} elseif ($sub_menu3 == 't_pemblap'){echo "Pembimbing Lapngan";}else{echo "Mahasiswa";} ?></legend>
                <?php
                ...
                <form class="form-horizontal" action="" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <input type="text" name="username" class="form-control" value="" placeholder="Password" maxlength="32" required>
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="control-label col-lg-3">NPP</label>
                    <div class="col-lg-9">
                      <input type="text" name="nip" class="form-control" value="" placeholder="NPP" maxlength="21" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-lg-3">NIDN</label>
                    <div class="col-lg-9">
                      <input type="text" name="nip" class="form-control" value="" placeholder="NIDN" maxlength="21" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-lg-3">Jabatan Fungsional</label>
                    <div class="col-lg-9">
                      <input type="text" name="nip" class="form-control" value="" placeholder="Jabatan Fungsional" maxlength="21" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-lg-3">Golongan</label>
                    <div class="col-lg-9">
                      <input type="text" name="nip" class="form-control" value="" placeholder="Golongan" maxlength="21" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-lg-3">Email</label>
                    <div class="col-lg-9">
                      <input type="text" name="nip" class="form-control" value="" placeholder="Email" maxlength="21" required>
                    </div>
                  </div>
                ...
                // lap
                elseif ($sub_menu3 == 't_pemblap') {?>
                  <form class="form-horizontal" action="" method="post">
                    <div class="form-group">
                      <label class="control-label col-lg-3">Nama Jurusan siswa</label>
                      <div class="col-lg-9">
                        <select class="form-control cari_jurusan" name="jurusan" required style="width:100%;">
                          <option value="">-- Pilih Jurusan --</option>
                          <?php foreach ($v_jurusan->result() as $baris){ ?>
                    ...
                    <a href="javascript:history.back()" class="btn btn-default"><< Kembali</a>
                    <button type="submit" name="btnsimpan3" class="btn btn-primary" style="float:right;">Simpan</button>
                  </form>
                  <?php
                  }
                  ...
                  <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                    ...
                    <!-- <div class="form-group">
                      <label class="control-label col-lg-3">NPM & Password</label>
                      <div class="col-lg-9">
                        <input type="text" name="nis" class="form-control" value="" placeholder="NIS" maxlength="11" required>
                      </div>
                    </div> -->
                    <div class="form-group">
                      <label class="control-label col-lg-3">NPM</label>
                      <div class="col-lg-9">
                        <input type="text" name="nis" class="form-control" value="" placeholder="NPM" maxlength="11" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Password</label>
                      <div class="col-lg-9">
                        <input type="text" name="nis" class="form-control" value="" placeholder="Password" maxlength="11" required>
                      </div>
                    </div>
