        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"><i class="icon-user"></i> Detail Pengguna <?php if ($sub_menu3 == 'd_pemb') {echo "Pembimbing";}if ($sub_menu3 == 'd_pemblap') {echo "Pembimbinglapangan";}else{echo "Siswa";} ?></legend>
                <?php
                echo $this->session->flashdata('msg');
                ?>
                <center>
                  <img src="foto/<?php if ($sub_menu3 == 'd_pemb') { echo'default.png'; }elseif ($sub_menu3 == 'd_pemblap') { echo'default.png'; }else{echo "siswa/$user->foto";}?>" alt="<?php echo $user->nama_lengkap; ?>" class="img-circle" width="176" height="176">
                  <br>
                  <b>
                    <?php if ($sub_menu3 == 'd_pemb') {echo "Pembimbing";}elseif ($sub_menu3 == 'd_pemblap') {echo "Pembimbing Lapangan";}else{echo "Siswa";} ?>
                  </b>
                </center>
                <hr>
                <?php
